...
fun CheckOutScreenUi(
    ...
    val selectedMethod = remember { mutableStateOf("Standard FREE delivery over Tk.4500") }
            ...
            when {
                ...
                state.value.userData == null -> {
                    ...
                    Column {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            RadioButton(
                                selected = selectedMethod.value == "Standard FREE delivery over Tk.4500",
                                onClick = {
                                    selectedMethod.value = "Standard FREE delivery over Tk.4500"
                                }
                            )
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            RadioButton(
                                selected = selectedMethod.value == "Cash on delivery Tk.50",
                                onClick = { selectedMethod.value = "Cash on delivery Tk.50" }
                            )
                            Spacer(modifier = Modifier.width(8.dp))
